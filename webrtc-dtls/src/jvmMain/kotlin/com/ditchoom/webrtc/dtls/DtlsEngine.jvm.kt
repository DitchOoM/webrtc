...
// No native DTLS backend on this target this wave — JVM (boringssl-kmp FFM MRJAR pending). See the EXECUTION_PLAN
...
public actual class DtlsEngine actual constructor(
    ...
    init {
        throw DtlsException(
            ...
            "DTLS backend not available on this target — JVM (boringssl-kmp FFM MRJAR pending)",
        )
    }
