...
// JVM: buffer-crypto's key agreement is JCA and fulfils deriveTlsPremasterSecret synchronously, so
// runBlocking returns without ever suspending on an external dispatcher (no deadlock under runTest).
