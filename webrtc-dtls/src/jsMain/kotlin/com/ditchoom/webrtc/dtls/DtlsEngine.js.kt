...
// No native DTLS backend on this target this wave — JS (browsers delegate DTLS to RTCPeerConnection). See the EXECUTION_PLAN
...
public actual class DtlsEngine actual constructor(
    ...
    init {
        throw DtlsException(
            ...
            "DTLS backend not available on this target — JS (browsers delegate DTLS to RTCPeerConnection)",
        )
    }
